      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center h-full">
        ...
        <div className="relative z-20 flex flex-col items-center px-4 py-8 mx-auto text-center max-w-6xl">
          ...
          <div className="w-full max-w-3xl mt-10 flex flex-col md:flex-row gap-4 justify-center">
            <button className="flex-1 px-8 py-4 bg-[var(--primary-red)] text-white font-bold rounded-full shadow-lg transition duration-300 hover:bg-[var(--primary-red-hover)] hover:shadow-xl hover:scale-105 text-lg md:text-xl">
              Explore Miami Homes
            </button>
            <button className="flex-1 px-8 py-4 bg-white text-[var(--primary-red)] font-bold rounded-full shadow-lg border-2 border-[var(--primary-red)] transition duration-300 hover:bg-gray-50 hover:shadow-xl hover:scale-105 text-lg md:text-xl">
              Beachfront Getaways
            </button>
          </div>
