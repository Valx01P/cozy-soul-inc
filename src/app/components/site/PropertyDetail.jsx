...
import UpdatedPropertyPriceCard from './UpdatedPropertyPriceCard'
...
export default function PropertyDetail({ params }) {
  ...
  return (
    <div className="flex flex-1 flex-col md:flex-row justify-center bg-[#F5F5F5] p-4 gap-6">
      ...
      <div className="md:w-80 lg:w-96">
        {!loading && property && (
          <UpdatedPropertyPriceCard property={property} id={id} />
        )}
      </div>
    </div>
  )
